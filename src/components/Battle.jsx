        ...
        <div id='arena' class='clear' style={{width:"100%",  height: "30%", display:'flex', justifyContent:'space-around', alignItems:"center"}}>
          <div style={{display: 'flex', height:'100%', width:"40%"}}>
            <div style={{height:'100%', display:'flex', flexDirection:'column'}}>
              <div style={{height:'45%'}}>
               {jar[0].name && <img src={`bugs/${jar[0].name.toLowerCase().replaceAll(' ', '')}.png`} style={{height:'100%'}} alt={jar[0].name} />}
              </div> 
            </div>
            <div style={{height:'100%', display:'flex', flexDirection:'column-reverse'}}>
              <div style={{height:'45%'}}>
                {jar[1].name && <img src={`bugs/${jar[1].name.toLowerCase().replaceAll(' ', '')}.png`} style={{height:'100%'}} alt={jar[0].name} />}
              </div>
            </div>
          </div>
