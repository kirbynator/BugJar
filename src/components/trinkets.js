const trickets = [
  ...
  {name: "Flash Light", rarity: "13", type:"a", search: "Moth Aphid", effect: "Attracts Moths and Aphids"},
  {name: "Still Water", rarity: "12", type:"a", search: "Water Mosquito", effect: "Attracts Water Striders and Mosquitoes"},
  ...
  {name: "8 Ball", rarity: "123", search: "Spider Widow Tarantula Harvestmen", type: "a", effect: "Attracts Harvestmen, Tarantulas and Spiders"},
  {name: "Manga Page", rarity: "12", search: "Cicada Larva", type: "a", effect: "Attracts Larvae and Cicadas"},
  {name: "Sports Drink", rarity: "13", search: "Mantis Toe Weevil", type: "a", effect: "Attracts Toe-biters, Weevils, and Mantises"},
  ...
  {name: "Adrenaline", type:"m", move:{name: "Twitch", power: 1, pryo: 1, info: "This attack takes priority"}, effect: "Modifies a bug to know Twitch that wouldn't normally"},
  ...
  {name: "Hair Worm", type:"i", inft: 2, effect: "Infect a bug, making it stronger but locked into the first attack used"},
]
