const trickets = [
  ...
  {name: "Adrenaline", type:"m", move:{name: "Twitch", power: 1, pryo: 1, info: "This move goes first"}, effect: "Modifies a bug to know Prevention Twitch that wouldn't normally"},
]
